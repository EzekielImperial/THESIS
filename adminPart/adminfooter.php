                    ...
                    <div class="col-lg-3 col-md-3">
                        <ul class="list-unstyled clear-margins">
                            <li class="widget-container widget_nav_menu">
                                ...
                                <ul>
                                    <li><a href="../productlocation/producview_women.php"><i class="fa fa-angle-double-right"></i>  WOMAN</a></li>
                                    <li><a href="../productlocation/producview_men.php"><i class="fa fa-angle-double-right"></i>  MAN</a></li>
                                    ...
                                    <li><a href="../productlocation/producview_latest.php"><i class="fa fa-angle-double-right"></i>  LATEST</a></li>
